"""
Configurações base do Django - Despesa Certa
Configurações comuns entre todos os ambientes
"""
...
MIDDLEWARE = [
    ...
    "backend_expenses.crypto_middleware.PasswordDecryptionMiddleware",
