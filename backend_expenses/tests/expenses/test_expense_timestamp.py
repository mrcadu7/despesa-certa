...
def test_filter_expense_by_created():
    ...
    expense1 = Expense.objects.create(user=user, value=10, category='Alimentação', date=date.today())
    expense2 = Expense.objects.create(user=user, value=20, category='Transporte', date=date.today())
